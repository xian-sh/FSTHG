...
class Attention(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        attn = self.attend(dots)  # 64, 4, 6, 6
        # print(attn.shape)
...
class VanillaTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        # Adjust this pattern to match your input shape
        # self.to_patch_embedding = nn.Sequential(
        #     Rearrange('b c (h p1) (w p2) -> b (c h w) (p1 p2)', p1=t_patch_size, p2=t_patch_size),
        #     nn.Linear(t_patch_size * t_patch_size, hid_channels),
        # )
